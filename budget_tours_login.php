      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="tour_login.html">Головна</a></span> <span>Тур</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Бюджетні тури</h1>
          </div>
        </div>
      </div>
    </div>
<br>
<h2 align="center">Бюджетні тури:</h2>
<br>
    <?php
    include ("classes/Singleton_budget.php");
    include("classes/Proxy_budget.php");
    include("classes/SettlementInfo_budget.php");
    include ("classes/MyIterator_budget.php");

    $db = Singleton::getInstance();
    $mysqli = $db->getConnection();
    $sql_query = "SELECT * FROM budget_tours";
